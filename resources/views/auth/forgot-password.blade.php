    ...
    <!--------------------------- Left Box ----------------------------->
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box bg-primary shadow-md">
           <div class="featured-image mb-3">
            <img src="/assets/img/1.jpg" class="img-fluid rounded-3" style="width: 100%; height:100%">
           </div>
    ...
    <!-------------------- ------ Right Box ---------------------------->
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3">
                    <button class="btn btn-lg btn-primary w-100 fs-6" type="submit" > Kirim email reset password </button>
                </div>
                </form>
          </div>
       </div> 
