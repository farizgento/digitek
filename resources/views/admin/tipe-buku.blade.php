        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ route('store-tipe-admin') }}" method="post">
                        @csrf
                        <div class="card-body">
            ...
            <tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('update-tipe-admin', $tipebuku) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" hidden name="sekolah_id" value="{{ $tipebuku->sekolah_id }}">
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('delete-tipe-admin',$tipebuku) }}" method="post">
                            @csrf
                            @method('DELETE')
                            <div class="card-body">
                                <div class="form-group">
