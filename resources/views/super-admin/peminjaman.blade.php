        ...
        <table class="table table-head-fixed text-nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $peminjaman->sekolahs->nama }}</td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('update-peminjaman-super', $peminjaman) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select rounded-0" id="exampleSelectRounded0" name="konfirmasi_pinjam">
                                        @foreach (App\Models\Peminjaman::getKonfirmasiPeminjamanValues() as $value)
                                            <option value="{{ $value }}" @if($peminjaman->konfirmasi_peminjaman == $value) selected @endif>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
